  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
        ...
        <h2 className='my-5 maxx-w-lg truncate mx-auto'>{data.subTitle}</h2>
      ...
      <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
        ...
        {/*comment section*/}
          ...
          <div className='max-w-3xl mx-auto'>
            ...
            <form onSubmit={addComment} className='flex flex-col items-start ga-4 max-w-lg'>
              ...
              <textarea onChange={(e)=> setContent(e.target.value)} value={content} rows="4" placeholder='Comment' className='w-full p-2 border border-gray-300 rounded outline-none h-48'/>
